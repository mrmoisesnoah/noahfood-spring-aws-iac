...
public class NoahRdsStack extends Stack {
    public NoahRdsStack(final Construct scope, final String id, final Vpc vpc) {
        this(scope, id, null, vpc);
    }

    public NoahRdsStack(final Construct scope, final String id, final StackProps props, final Vpc vpc) {
        ...
        DatabaseInstance database = DatabaseInstance.Builder
                ...
                .instanceIdentifier("noah-aws-pedido-db")
